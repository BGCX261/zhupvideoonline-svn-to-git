...
rs.open "Select * From StuZoneType",conn,1,3

if Request.QueryString("no")="yes" then
nbtyped= Trim(Request("nbtyped"))
Brief= Trim(Request("Brief"))
if nbtyped<>"" then
sql="delete from StuZoneType where nbtyped='" & nbtyped & "'"
conn.Execute  sql
sql="delete from StuZone where nbtyped='" & nbtyped & "'"
conn.Execute sql
end if
...
<table align="center" class="a2">
	...
	<tr class="a4">
		<td>
          <form method="post" action="Bs_nbType.asp?no=eshop" name="myform" onSubmit="return CheckForm()">
			<table width="100%">
                <tr> 
