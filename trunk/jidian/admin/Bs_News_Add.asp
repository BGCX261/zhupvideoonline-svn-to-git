...
dim rs1,sql1,sel1           
 ...
 rs1.open sql1,conn,1,1           
        ...
        </select>  作者<input name="author" type="text" id="author" value='<%if session("realname") then response.write(session("realname")) else response.write ("请输入")end if%>' /> 是否置顶：<input name="toTop" type="checkbox" id="toTop" value="yes">
