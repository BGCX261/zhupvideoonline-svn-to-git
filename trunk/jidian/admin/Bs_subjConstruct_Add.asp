...
<table align="center" class="a2">
	<tr>
		<td class="a1">添加党建工作信息</td>
	</tr>
	<tr class="a4">
		<td>
          <form method="post" action="Bs_subjConstruct_Add.asp?no=eshop" name="myform" onSubmit="return CheckForm()">
			<table width="100%">
								<tr> 
...
作者<input name="author" type="text" id="author" value='<%if session("realname") then response.write(session("realname")) else response.write ("请输入")end if%>' readonly="readonly" /> 是否置顶：<input name="toTop" type="checkbox" id="toTop" value="yes">
