...
sql="select * from FacResourceType where id="&id
...
if frtype<>Oldfrtype then
	conn.execute "Update FacResource set frtype='" & frtype & "' where frtype='" & Oldfrtype & "'"
end if	
...
Set rs = Server.CreateObject("ADODB.Recordset")
rs.Open "Select * From FacResourceType where id="&id, conn,3,3
%>
...
<table align="center" class="a2">
	...
	<tr class="a4">
		<td>
          <form method="post" action="Bs_facType_edit.asp?no=eshop">
