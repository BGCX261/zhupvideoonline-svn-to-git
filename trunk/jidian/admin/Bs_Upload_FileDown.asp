...
strFileName="Bs_Upload_FileDown.asp"
...
if right(SaveUpFilesPathDown,1)<>"/" then
	UploadDir="../" & SaveUpFilesPathDown & "/"
else
	UploadDir="../" & SaveUpFilesPathDown
end if
...
<table align="center" class="a2">
	<tr>
		<td class="a1">大 文 件 上 传 文 件 管 理</td>
	</tr>
	<tr class="a4">
		<td>
<%
...
%>
        <tr class="opt"> 
          ...
          <td><a href="Bs_Upload_FileDown.asp?Action=Del&FileName=<%=UploadDir&theFile.Name%>" onClick="return ConfirmDel()">删除</a></td>
        </tr>
<%
		FileCount=FileCount+1
		TotleSize=TotleSize+theFile.Size
