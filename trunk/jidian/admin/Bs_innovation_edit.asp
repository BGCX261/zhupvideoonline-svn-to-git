...
sql="select * from innovation where id="&id
...
Set rs = Server.CreateObject("ADODB.Recordset")
rs.Open "Select * From innovation where id="&id, conn,3,3
%>
<script>
function CheckForm(){
...
<table align="center" class="a2">
	<tr>
		<td class="a1">修改创新专题信息</td>
	</tr>
	<tr class="a4">
		<td>
					<form method="post" action="Bs_innovation_edit.asp?no=eshop" name="myform" onSubmit="return CheckForm();">
