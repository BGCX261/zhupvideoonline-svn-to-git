...
sqlBig="select * from scType where nbtyped='" & nbtyped & "'"
...
sql="select * from Scientific where id="&id
...
<table align="center" class="a2">
	<tr>
		<td class="a1">修改教学科研信息</td>
	</tr>
	<tr class="a4">
		<td>
					<form method="post" action="Bs_Scientific_edit.asp?no=eshop" name="myform" onSubmit="return CheckForm();">
