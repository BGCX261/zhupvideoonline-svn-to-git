...
sql="select * from StuZoneType where id="&id
...
if nbtyped<>Oldnbtyped then
	conn.execute "Update StuZone set nbtyped='" & nbtyped & "' where nbtyped='" & Oldnbtyped & "'"
end if	
...
Set rs = Server.CreateObject("ADODB.Recordset")
rs.Open "Select * From StuZoneType where id="&id, conn,3,3
%>
<script>
function CheckForm(){
...
<table align="center" class="a2">
	...
	<tr class="a4">
		<td>
          <form method="post" action="Bs_nbType_edit.asp?no=eshop" name="myform" onSubmit="return CheckForm()">
