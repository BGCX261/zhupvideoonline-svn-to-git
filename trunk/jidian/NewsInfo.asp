...
%>
              <div class="contentbox">
                  ...
                  <div class="chphittd">[ 字体: <a href="javascript:ContentSize(18)">大</a> <a href="javascript:ContentSize(14)">中</a> <a href="javascript:ContentSize(12)">小</a> ] 发布日期：[<%=formatdatetime(rs("mdy_time"),2)%>] 阅读:[<%=rs("counter")%>]次</div>
