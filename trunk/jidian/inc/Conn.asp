...
Dim sql_BsCo,rs_BsCo,BsCompanyName,BsAddress,BsLinkman,BsPhone,qq,BsFax,BsWeb,BsEmail,BsZipcode,BsICPcode,menunav,menunavTime,copyRight
...
menunav=trim(rs_BsCo("menunav"))
menunavTime=rs_BsCo("menunavTime")
copyRight=rs_BsCo("copyRight")
