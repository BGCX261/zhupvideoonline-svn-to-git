...
<div id="body">
  <table class="bodytable">
    <tr>
      <td class="bodyleft">
          <!-- #include file="L_profile.asp" -->
      </td>
      <td class="bodyline"></td>
      <td class="bodyright">
      <!-- #include file="Inc/headAd.asp" -->
        <div class="mbox">
          <div class="positiontitle"><img src="img/title_ico.gif" /> 学院概况</div>
<%
...
rs.Open "Select * From Profile where id="&id, conn,3,3
'纪录访问次数
...
%>
              <div class="contentbox">
                ...
                <div class="chphittd">字体大小:[ <a href="javascript:ContentSize(16)">大 </a
><a href="javascript:ContentSize(14)">中 </a
><a href="javascript:ContentSize(12)">小 </a
> ] 时间:[<%=rs("time")%>]  点击:[<%=rs("counter")%>]
                </div>
