...
sub upload_0()    '使用化境无组件上传类
	...
	for each formName in upload.file '列出所有上传了的文件
		...
		if founderr<>true then
			...
			strJS=strJS & "parent.myform.honor.focus();" & vbcrlf 	  		
			strJS=strJS & "var range = parent.myform.honor;" & vbcrlf
...
'			strJS=strJS & "parent.parent.myform.IncludePic.checked=true;" & vbcrlf
	  		strJS=strJS & "parent.myform.honor.value='" & FileName & "';" & vbcrlf
...
'			strJS=strJS & "parent.parent.myform.DefaultPicList.selectedIndex+=1;" & vbcrlf
			strJS=strJS & "if(parent.document.images['tou']){" & vbcrlf
			strJS=strJS & "parent.document.images['tou'].src='../'+'" & FileName & "';}" & vbcrlf 
