...
%>
              <table width="100%">
                ...
                <tr>
                  <td class="chphittd">[ 字体: <a href="javascript:ContentSize(16)">大</a> <a href="javascript:ContentSize(14)">中</a> <a href="javascript:ContentSize(12)">小</a> ] 发布日期：[<%=rs("time")%>] 阅读:[<%=rs("counter")%>]次</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="prt">【<a href='javascript:window.print()'>打印此页</a
