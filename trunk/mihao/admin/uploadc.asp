...
<%
if EnableUploadFile="Yes" and  User_Group="admin"  then
%>
<form action="upfilec.asp" method="post" name="form1" onSubmit="return check_file()" enctype="multipart/form-data">
