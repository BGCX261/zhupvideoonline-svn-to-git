...
Else
	...
	pic_dy=lcase(HTMLEncode(Rs("Content")))
		If instr(pic_dy,"img")=0 Then
		Response.Write"<li><a href=""contextSingle.asp?id="&Rs("ID")&"""><img src=""images/showerr.gif"" alt="""&Rs("title")&""" ><br>"&Rs("title")&"</a></li>"
		Rs.movenext
		Else
	...
	pic_dy=lcase(HTMLEncode(Rs("Content")))
	    If instr(pic_dy,"img")=0 Then
		Response.Write"<li><a href=""context.asp?id="&Rs("ID")&"""><img src=""images/showerr.gif"" alt="""&Rs("title")&""" ><br>"&Rs("title")&"</a></li>"
		Rs.movenext
		Else
		pic_dy=left(pic_dy,instr(pic_dy,"[/img]")-1)
		pic_dy=right(pic_dy,len(pic_dy)-4-instr(pic_dy,"[img]"))
