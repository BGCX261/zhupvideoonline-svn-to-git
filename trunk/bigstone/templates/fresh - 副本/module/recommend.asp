...
<div class="box2" id="recommend">
  <div class="head"><span>{$L_RECOMMEND}</span><a class="more" href="{$S_ROOT}?product.{$suffix}"><img src="{$S_TPL_PATH}images/more.gif" /></a></div>
  <div class="main">
  <!-------------------------->
  <div id="roll">
    <div id="roll_sheet" onmouseover="over_roll()" onmouseout="out_roll()">
      ...
      <div name="roll_unit">
        <table cellspacing="0" cellpadding="0">
          ...
          <tr><td class="title">
            <a href="{$S_ROOT}?product_{$recommend[$i]['art_id']}.{$suffix}" target="_blank">{$left($recommend[$i]['art_title'],11)}</a>
          </td></tr>
        </table>
      </div>
      {/for}
