...
dim tpl:tpl = txt
%>
<div class="here">编辑语言文件 - <%=fil%></div>
<div class="block sheet">
  <form name="form_edit_lang" method="post" action="deal.asp" target="deal">
    <input name="cmd" type="hidden" value="edit_lang" />
    <input name="fil" type="hidden" value="<%=fil%>" />
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
          <textarea name="lang" rows="20" cols="100"><%=tpl%></textarea>
        </td>
      </tr>
      <tr>
        <td class="button">
          <input type="submit" onclick="do_submit('form_edit_lang')" value="提交" />
