...
dim download(0,3)
download(0,0) = "down"
download(0,1) = "downnnnnnnnnn"
download(0,2) = "2013/8/23 21:04:24"
download(0,3) = ""
download_u = 0
dim download_name(3)
download_name(0) = "art_title"
download_name(1) = "art_text"
download_name(2) = "art_add_time"
download_name(3) = "att_url"
page_sum = 1
record_sum = 1
cat = 0
page = 1
...
service = "在线客服"
%>
<!-- #include file="../compile/download.asp" -->
