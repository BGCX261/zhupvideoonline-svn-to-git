...
<div class="img_sheet">
  ...
  <div class="unit"><div class="in">
    <table cellspacing="0" cellpadding="0">
      ...
      <tr><td class="title">
        <a href="{$S_ROOT}?product_{$search[$i]['art_id']}.{$suffix}" target="_blank">{$left($search[$i]['art_title'],11)}</a>
      </td></tr>
    </table>
  </div></div>
  {/for}
...
<div class="page_link"><div class="in">
  ...
  {if:$page_sum,neq,1}
    ...
    <a class="num" href="{$S_ROOT}?search_{$cat}_{$page}_0.{$suffix}" style="color:#7fb402;">【{$page}】</a>
